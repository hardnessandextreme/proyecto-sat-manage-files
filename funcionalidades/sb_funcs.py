        ...
        try:
            ...
            for linea in archivo:
                ...
                if int(lista[0]) == id_materia:
                    print('\nError: El ID de la materia ya existe en el archivo.')
                    archivo.close()
                    return
        ...
        try:
            ...
            for linea in archivo:
                ...
                if int(lista[0]) == id_docente:
                    print('\nError: El ID del docente ya existe en el archivo.')
                    archivo.close()
                    return
...
def consultar_especifica(tipo, identificacion):
    limpiar_pantalla()
    if tipo == 'Alumnos':
        print(f'Busqueda de datos de {tipo}\n')
        try:
            archivo = open('datos/usuarios.txt', 'r', encoding='utf-8')
            ...
            print(f'\nError al consultar el registro: {E}\n')
